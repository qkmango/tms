    ...
    var mod = {
        ...
        render: function (myTable) {
            ...
            for (let i = 0; i < cols.length; i++) {
                let item3 = cols[i], field=item3.field;
                if (item3.merge) {
            ...
            function isMaster (index, item) {
                let mergeField = mergeRecord[item].mergeField;
                let dataLength = layui.table.cache[myTable.id].length;
                for (let i=0; i<mergeField.length; i++) {
